...
drop table SupplierPartsProject;
...
insert into SupplierPartsProject (S_id, Parts_id, Projects_id, Qty)
values (1, 1001, 21, 300);

insert into SupplierPartsProject (S_id, Parts_id, Projects_id, Qty)
values (2, 1002, 22, 400);

insert into SupplierPartsProject (S_id, Parts_id, Projects_id, Qty)
values (3, 1003, 23, 600);

insert into SupplierPartsProject (S_id, Parts_id, Projects_id, Qty)
values (4, 1004, 24, 250);

insert into SupplierPartsProject (S_id, Parts_id, Projects_id, Qty)
values (5, 1005, 25, 350);
